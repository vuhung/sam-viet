...
namespace WorldMap
{
    ...
    public partial class MainPage : UserControl
    {
        ...
        void MainPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            this.WorldMapController.LoadUserComment_Completed += new EventHandler(WorldMapController_LoadUserComment_Completed);
            this.WorldMapController.GetProject_Completed += new EventHandler(WorldMapController_GetProject_Completed);
        ...
        void InitializeAfterLoggigIn()
        {
            ...
            ProjectDetailControl.InitializeAfterLogin();
        ...
        void InitializeAfterLoggigOut()
        {
            ...
            ProjectDetailControl.InitializeAfterLogout();
        ...
        public void WorldMapController_LoadUserComment_Completed(object sender, EventArgs e)
        {
            try
            {
                string projectId = System.Windows.Browser.HtmlPage.Document.QueryString["projectId"];
                this.KFC(int.Parse(projectId));
            }
            catch (Exception ex)
            {
            }
        ...
        private void KFC(int projectId)
        {
            currentProject = new tbl_projects();
            WorldMapController.GetWBProject(projectId);
            currentProject.project_id_pk = projectId;
        }
        ...
        public void WorldMapController_GetProject_Completed(object sender, EventArgs e)
        {
            ...
            {
                currentProject = x;
                this.ProjectDetailControl.Visibility = Visibility.Visible;
        ...
        void MyWorkSpace_FacebookPost(object sender, EventArgs e)
        {
            ...
            if (graph.type != "project")
            {
                ...
                string uri = "http://www.facebook.com/share.php?u=http://www.ncrvisual.co.cc/WorldMap.aspx?country=" + tbl_country.country_name + "%26indicatorId=" + graph.indicator_list;
                HtmlPage.Window.Navigate(new Uri(uri), "__blank");
            }
            else
            {
                string uri = "http://www.facebook.com/share.php?u=http://www.ncrvisual.co.cc/WorldMap.aspx?projectId=" + graph.project_id;
                HtmlPage.Window.Navigate(new Uri(uri), "__blank");
            }
        }
        ...
        {
            List<ref_country_indicator> result = (sender as IEnumerable<ref_country_indicator>).ToList<ref_country_indicator>();
            ...
            //Determine the number of country in a range - there're 5 ranges
            int capacity = countryNumber / 5;
            ...
            foreach (ref_country_indicator r in result)
            {
                ...
                WorldMapController.GetCountryBorder(isoCode, new SolidColorBrush(Color.FromArgb(opacity[count / capacity], 39, 136, 59)), country.country_name + ": " + String.Format("{0:N}", r.country_indicator_value));
                count++;
            }
